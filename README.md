...
This is my progress for 30 days of Kotlin

# Day 

## Day 10 

I learned about preferences in android and implemented them with the help of kotlin.
So what are preferences, basically prefrences are used to save data within the android application, they are save key-data.
...
This is also used to hold the progress of the application like.
check if user is is loged in or not, save the data into the memory like text, images and many more.
